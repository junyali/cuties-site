...
export function ProjectLink({ link }: { link: ProjectLink}) {
	...
	return (
		<a
			...
			className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium border transition-all duration-300 hover:-translate-y-0.5 ${colours[link.type]}`}
		>
